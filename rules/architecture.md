...
**Comment :** charger et suivre la skill **`hexagonal-dotnet`** (ports API/SPI, In-Proc Adapters,
...
> Le principe Hive est agnostique langage ; la skill how-to est aujourd'hui .NET. Ne s'applique
> qu'aux back-ends : les front-ends / UI consomment les ports API des modules sans être en ruche.
